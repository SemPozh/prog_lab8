...
public class CollectionManager {
    ...
    public void insertAt(Integer index, Organization el) throws IndexOutOfBoundsException, ConnectionErrorException, SQLException {
     ...
     */
    public void addToCollection(Organization organization) throws ConnectionErrorException, SQLException {
        Connection connection = DatabaseManager.getConnection();
        try {
     ...
     */
    public void clearCollection(User user) throws SQLException, ConnectionErrorException {
        Connection connection = DatabaseManager.getConnection();
     ...
     */
    private void loadCollection() throws ConnectionErrorException, SQLException {
